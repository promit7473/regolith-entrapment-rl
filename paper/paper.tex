...
\begin{figure}[!htbp]
  ...
  \caption{Top-down terminal-position distribution over 33\,935 training
    episodes (representative seed~1).  The escape direction $\hat{\mathbf{e}}$ is randomised uniformly
...
rather than mean-pooling across qualitatively different regimes. Single-seed
training-curve diagnostics (Figs.~\ref{fig:training_overview},
\ref{fig:topdown_heatmap}) are shown for the representative seed~1.
