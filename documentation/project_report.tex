...
%% ─── RPi5 bounding box (drawn before arrows so it sits behind) ───
\node[rectangle, draw=black!45, thick, rounded corners=8pt,
      dashed, fill=blue!2,
      minimum width=11.6cm, minimum height=10.4cm]
      (rpi) at (0, 1.6) {};
...
% "escaped" dashed feedback: esc.north → up → left → dmd.north
\draw[da] (esc.north) -- ++(0, 2.0) -| (dmd.north)
    node[pos=0.35, above, font=\scriptsize\itshape,
