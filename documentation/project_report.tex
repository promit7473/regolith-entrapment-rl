...
\vspace{4pt}
\begin{tcolorbox}[objbox, colframe=headerblue, title={5.\enspace Sim-to-Real Transfer}]
: Establish a complete deployment pipeline comprising domain randomisation during training,
ONNX export of the trained GRU policy, and real-time inference on a Raspberry Pi 5,
bridging the simulation-to-reality gap for onboard autonomous operation.
\end{tcolorbox}
\vspace{6pt}
