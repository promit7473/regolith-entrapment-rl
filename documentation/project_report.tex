...
\begin{tikzpicture}[
    ...
    grubox/.style={rectangle, draw=black, thick, fill=lightblue!30, minimum width=1.8cm, minimum height=1.2cm, align=center, font=\small},
    arrow/.style={-Stealth, thick},
...
% ─── Dashed outer box ───
\node[dashedbox, minimum width=28cm, minimum height=13cm, fill=white] at (9.5, 0) {};
